...
<div class="col-md-12" style="height: 30%">
    ...
    <div class="col-md-12">
	    ...
	    <div class="col-md-4 col-md-offset-2">
		    <form id="reportSearchForm" action="/push/pushSuccess" method="get" >
		...
		<div class="table-responsive">
			<table class="table table-hover" style="font-size: large;">
				...
				<c:if test="${fn:length(reportList) == 0 }">
					<tr>
						<td colspan="5" style="text-align: center">Success 데이터가 존재하지 않습니다.</td>
					</tr>
				</c:if> 
				</tbody>
			</table>
