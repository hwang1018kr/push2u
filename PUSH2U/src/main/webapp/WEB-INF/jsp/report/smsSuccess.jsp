...
<div class="col-md-12" style="height: 30%">
	<div class="page-header col-md-12">
          ...
          <ol class="breadcrumb" style="background-color: white; margin-bottom: 0px;">
			  ...
			  <li class="active">SMS 성공 상세 보기</li>
		  </ol>
    </div>
    ...
    <div class="col-md-12">
	    ...
	    <div class="col-md-4 col-md-offset-2">
		    <form id="reportSearchForm" action="/push/smsSuccess" method="get" >
			...
			<table class="table table-hover" style="font-size: large;">
				<thead>
					<tr class="active">
						...
						<th style="width: 25%; text-align: center;">고객 ID</th>
				...
				<tbody>
					...
					<c:if test="${fn:length(reportList) == 0 }">
						<tr>
							<td colspan="3" style="text-align: center">SMS 성공 데이터가 존재하지 않습니다.</td>
						</tr>
					</c:if>
				</tbody>
			</table>
